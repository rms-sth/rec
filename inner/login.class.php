...
class Log extends Common{
	...
	public function save()
	{
		...
		$sql = "insert into tbl_user_register (firstname,middlename,lastname,username,password,email) values('$this->firstname','$this->middlename','$this->lastname','$this->username', '$this->password', '$this->email') ";
		echo $sql;
		$conn = new mysqli('localhost','root','','db_recommend');
